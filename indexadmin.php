...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/carillas.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Bienvenido(a) a la <b>Clínica</b></h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
							<img src="../LoginNoeLook/assets/img/logologin.png" width="330" height="150" >
								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm">Tu usuario o correo electrónico</label>
									<input type="text" placeholder="Usuario/Correo" name="username" class="form-control mb">
